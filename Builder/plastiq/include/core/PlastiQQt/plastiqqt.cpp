...
QHash<QByteArray, PlastiQMethod> PlastiQQt::plastiqConstructors = {

};

QHash<QByteArray, PlastiQMethod> PlastiQQt::plastiqMethods = {

};

QHash<QByteArray, PlastiQMethod> PlastiQQt::plastiqSignals = {

};

QHash<QByteArray, PlastiQProperty> PlastiQQt::plastiqProperties = {

};

QHash<QByteArray, long> PlastiQQt::plastiqConstants = {
   ...
   { "AA_X11InitThreads", Qt::AA_X11InitThreads },
   ...
   { "AA_DisableHighDpiScaling", Qt::AA_DisableHighDpiScaling },
   ...
   { "RFC2822Date", Qt::RFC2822Date },
   { "ISODateWithMs", Qt::ISODateWithMs },
   ...
   { "ImhSensitiveData", Qt::ImhSensitiveData },
   ...
   { "ImhDate", Qt::ImhDate },
   { "ImhTime", Qt::ImhTime },
   { "ImhPreferLatin", Qt::ImhPreferLatin },
   { "ImhMultiLine", Qt::ImhMultiLine },
   ...
   { "BeginNativeGesture", Qt::BeginNativeGesture },
   { "EndNativeGesture", Qt::EndNativeGesture },
   { "PanNativeGesture", Qt::PanNativeGesture },
   { "ZoomNativeGesture", Qt::ZoomNativeGesture },
   { "SmartZoomNativeGesture", Qt::SmartZoomNativeGesture },
   { "RotateNativeGesture", Qt::RotateNativeGesture },
   { "SwipeNativeGesture", Qt::SwipeNativeGesture },
   ...
   { "TextForceLeftToRight", Qt::TextForceLeftToRight },
   { "TextForceRightToLeft", Qt::TextForceRightToLeft },
   { "TextLongestVariant", Qt::TextLongestVariant },
   { "TextBypassShaping", Qt::TextBypassShaping },
...
QVector<PlastiQMetaObject*> PlastiQQt::plastiqInherits = {  };

const PlastiQ::ObjectType PlastiQQt::plastiq_static_objectType = PlastiQ::IsNamespace;
PlastiQMetaObject PlastiQQt::plastiq_static_metaObject = {
    { Q_NULLPTR, &plastiqInherits, "Qt", &plastiq_static_objectType,
      &plastiqConstructors,
      &plastiqMethods,
      &plastiqSignals,
      &plastiqProperties,
...
const PlastiQMetaObject *PlastiQQt::plastiq_metaObject() const {
    return &plastiq_static_metaObject;
}

void PlastiQQt::plastiq_static_metacall(PlastiQObject *object, PlastiQMetaObject::Call call, int id, const PMOGStack &stack) {
